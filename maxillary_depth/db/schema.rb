...
ActiveRecord::Schema.define(version: 2019_06_16_192136) do

  create_table "exams", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.bigint "patient_id"
    t.geometry "point_n", limit: {:type=>"point", :srid=>0}
    t.geometry "point_a", limit: {:type=>"point", :srid=>0}
    t.geometry "point_po", limit: {:type=>"point", :srid=>0}
    t.geometry "point_or", limit: {:type=>"point", :srid=>0}
